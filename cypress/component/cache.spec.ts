...
import { CacheModule } from '../../packages/cache/lib';
...
describe(specTitle('@cranium/cache'), () => {
  ...
  it('should cache data to localStorage', () => {
    ...
    CacheModule.put({ key: 'localStorage-key' }, null);
  ...
  it('should cache data to sessionStorage', () => {
    ...
    CacheModule.put({ key: 'sessionStorage-key', storage: sessionStorage }, null);
  ...
  it('should cache data to custom storage', () => {
    ...
    CacheModule.put({ key: 'MyStorage-key', storage }, null);
